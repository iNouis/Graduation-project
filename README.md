...
1- Frontend Code: Source code for the user interface.
2- Backend Code: Logic and services that power the platform.
3- Documentation: Design files (Figma), and other documents.

# fourth: Team Members: 
Written and maintained by the Baraa | بَارِع team:

Atheer Almataani --- in Linkdin: 
